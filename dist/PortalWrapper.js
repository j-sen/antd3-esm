...
import { P as PropTypes } from './config-provider.js';
import { p as polyfill, C as ContainerRender, P as Portal$1 } from './menu.js';
...
var IS_REACT_16 = ('createPortal' in ReactDOM__default); // https://github.com/ant-design/ant-design/issues/19340
...
var PortalWrapper = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(PortalWrapper, [{
    ...
    value: function render() {
      ...
      if (!IS_REACT_16) {
        return /*#__PURE__*/React__default.createElement(ContainerRender, {
          parent: this,
          visible: visible,
          autoDestroy: false,
      ...
      if (forceRender || visible || this._component) {
        portal = /*#__PURE__*/React__default.createElement(Portal$1, {
          getContainer: this.getContainer,
          ref: this.savePortal
        }, children(childProps));
      }
...
var Portal = polyfill(PortalWrapper);

export { Portal as P, getScrollBarSize as g };
